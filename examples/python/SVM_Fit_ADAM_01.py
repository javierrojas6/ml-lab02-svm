...
parser.add_argument(
  '-r', type = str, default = 'lasso', help = '[ridge/LASSO]'
  )
...
numpy.concatenate( ( numpy.where(Y_train >= 1, 1, 0), 1 - numpy.where(Y_train >= 1, 1, 0) ), axis = 1 )
